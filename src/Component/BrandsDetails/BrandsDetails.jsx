...
export default function BrandsDetails() {
  ...
  const { addToWishlist, removeFromWishlist, getWishlist, wishList,RemoveClick } = useContext(WishlistContext);
  ...
  return <>
    <h3 className='h1 fw-bold text-center py-5'>{brand.name}</h3>
    {loading ? <Loading/>:
